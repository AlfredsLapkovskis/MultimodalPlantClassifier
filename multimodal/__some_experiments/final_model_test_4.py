    ...
    model.fit(
        ...
        callbacks=[
            ...
            keras.callbacks.TensorBoard(
                log_dir=os.path.join(config.get_log_dir(), "final_model_test_4", f"{neurons[0]}x{neurons[1]}x{neurons[2]}_{datetime.now()}"),
                histogram_freq=1,
            ),
        ],
    )
...
if __name__ == "__main__":
    ...
    neurons = [256, 256, 256] if args.c == 0 else [512, 512, 512]
